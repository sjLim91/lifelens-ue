...
{
    // Android can terminate a process shortly after backgrounding. Persist the
    // current Core snapshot before unregistering lifecycle delegates so a
    // throttled autosave cannot remain pending only in memory.
